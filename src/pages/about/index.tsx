        ...
        <div className="grid w-full grid-cols-8 gap-8 lg:gap-16">
          <div className="order-2 col-span-8 flex flex-col items-start justify-start md:order-1 md:col-span-4 xl:col-span-3">
            ...
            <p className="mb-4 text-sm font-medium md:text-base">
              ...
              front-end developer with strong attention to detail and a passion
              for creating clean, user-friendly websites and applications using
              HTML, CSS, JavaScript, and React. Continuously seeks to expand
              knowledge and skills in new technologies and techniques.
            </p>
